...
update data_kladr
	...
	set Population_density = isnull(f.Population_density, 8.57)

	from data_kladr as k 

	left join 
	(select distinct insurerKLADR, Population_density from data_kladr_city) as f
...
update data_osago_claims
	...
	set District_city_dist = isnull(d.District_city_dist, 101),
		...
		Population_density = isnull(d.Population_density, 8.57)
